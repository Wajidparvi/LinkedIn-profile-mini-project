...
export default function App() {
  ...
  useEffect(() => {
    setPosts([
      { id: 1, name: 'Alice Kumar', role: 'Software Engineer at Google',
        text: 'Just shipped my first React Native app! 🚀', likes: 12, liked: false },
      { id: 2, name: 'Rahul Singh', role: 'Product Manager at Microsoft',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.profileCard}>
          ...
          <Text style={styles.profileName}>Wajid Hussain</Text>
